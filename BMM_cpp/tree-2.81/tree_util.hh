...
template<class T>
void print_tree_indented(const tree<T>& t, std::ostream& str)
{
    typename tree<T>::iterator sib2=t.begin();
    typename tree<T>::iterator end2=t.end();
     while(sib2!=end2) {
       for(int i=0; i<t.depth(sib2); ++i)
              str << " ";
       str << (*sib2) << std::endl;
       ++sib2;
       }
